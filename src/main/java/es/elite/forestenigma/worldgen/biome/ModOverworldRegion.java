...
public class ModOverworldRegion extends Region {
    ...
    //Primer metodo, no funciona
    /*@Override
    public void addBiomes(Registry<Biome> registry, Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> mapper)
    {
        VanillaParameterOverlayBuilder builder = new VanillaParameterOverlayBuilder();
        // Overlap Vanilla's parameters with our own for our MOSSY biome.
        ...
        new ParameterUtils.ParameterPointListBuilder()
                ...
                .build().forEach(point -> builder.add(point, ModBiomes.MOSSY_BIOME));
    ...
    public void addBiomes(Registry<Biome> registry, Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> mapper) {
        addModifiedVanillaOverworldBiomes(mapper, modifiedVanillaOverworldBuilder -> {
            modifiedVanillaOverworldBuilder.replaceBiome(Biomes.SAVANNA, ModBiomes.MOSSY_BIOME);
        });
    }
}

...
public enum ModArmorMaterials implements ArmorMaterial {
    SYLVANITE("sylvanite", 26, new int[]{6, 9, 5, 5}, 25, SoundEvents.ARMOR_EQUIP_DIAMOND, 2f, 0f, () -> Ingredient.of(ModItems.SYLVANITE.get()));
    ...
    public String getName() {
        return ForestEnigma.MOD_ID + ":" + this.name;
    }
